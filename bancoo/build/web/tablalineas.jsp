                ...
                <div class="hidden sm:block sm:ml-6">
                  <div class="flex space-x-4">
                    <%
                        if (rol.equals("admin")) {
                    %>
                    <a href="indexa.jsp" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Usuarios</a>
                     <%}%>
          ...
          <table class="table table-dark table-striped">
            ...
            <form action="Servletlinea" method="post">
              <tr>
                  ...
                  <td><input type="number" value="<%=lista.getPlazo()%>" name="apla" class="text-black"></td>
                <td>
